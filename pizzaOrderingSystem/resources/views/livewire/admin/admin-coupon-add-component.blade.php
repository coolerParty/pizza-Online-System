			...
			<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
				<div class="d-md-flex">
					<ol class="breadcrumb ms-auto">
						...
						<li class="breadcrumb-item active"><a href="{{ route('admin.addcoupon') }}" class="fw-normal ">Add</a></li>
					</ol>
				</div>
			</div>
		</div>
				...
				<div class="white-box">
					...
					<form wire:submit.prevent="addCoupon" class="form-horzontal form-material">
						<div class="card-body">
                            ...
                            <div class="form-group">
								<label for="number">Coupon value</label>
