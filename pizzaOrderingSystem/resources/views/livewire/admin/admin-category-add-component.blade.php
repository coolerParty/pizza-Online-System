			...
			<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
				<div class="d-md-flex">
					<ol class="breadcrumb ms-auto">
						...
						<li class="breadcrumb-item active"><a href="{{ route('admin.addcategory') }}" class="fw-normal ">Add</a></li>
					</ol>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-8 col-sm-8">
				<div class="white-box">
					...
					<!-- form start -->
					<form wire:submit.prevent="addCategory" class="form-horzontal form-material">
						<div class="card-body">
