        ...
        <form wire:submit.prevent="placeOrder">
                ...
                <div class="inputBox">
                    <div class="input">
                        ...
                        <input class="@error('firstname') is-invalid @enderror" type="text"
                            placeholder="enter your firstname" name="firstname" wire:model="firstname">
                ...
                <div class="input">
                    <div>
                        <label for="different-add"><span>Change Shipping Address?</span>
                            <input id="different-add" name="different-add" value="1" type="checkbox"
            ...
            <div class="shipping-address bg-gray-100 px-4  py-6 rounded border">
                ...
                <div class="inputBox">
                    <div class="input">
                        <span>firstname</span>
                        <input class="@error('s_firstname') is-invalid @enderror" type="text"
                            placeholder="enter your firstname" name="s_firstname" wire:model="s_firstname">
                        @error('s_firstname') <span class="text-danger">{{ $message }}</span> @enderror
                    </div>
                    <div class="input">
                        <span>lastname</span>
                        <input class="@error('s_lastname') is-invalid @enderror" type="text"
                            placeholder="enter your lastname" name="s_lastname" wire:model="s_lastname">
                ...
                <div class="inputBox">
                    <div class="input">
                        <span>mobile</span>
                        <input class="@error('s_mobile') is-invalid @enderror" type="text"
                            placeholder="enter your mobile number" name="s_mobile" wire:model="s_mobile">
                        @error('s_mobile') <span class="text-danger">{{ $message }}</span> @enderror
                    </div>
                    <div class="input">
                        <span>email</span>
                        <input class="@error('s_email') is-invalid @enderror" type="email"
                            placeholder="enter your email address" name="s_email" wire:model="s_email">
                ...
                <div class="inputBox">
                    <div class="input">
                        <span>line1</span>
                        <textarea class="@error('s_line1') is-invalid @enderror" type="text"
                            placeholder="enter your address" name="s_line1" cols="30" rows="10"
                            wire:model="s_line1"></textarea>
                        @error('s_line1') <span class="text-danger">{{ $message }}</span> @enderror
                    </div>
                    <div class="input">
                        <span>line2</span>
                        <textarea class="@error('s_line2') is-invalid @enderror" type="text"
                            placeholder="enter your second address" name="s_line2" cols="30" rows="10"
                            wire:model="s_line2"></textarea>
                ...
                <div class="inputBox">
                    <div class="input">
                        <span>city</span>
                        <input class="@error('s_city') is-invalid @enderror" type="text" placeholder="enter your city"
                            name="s_city" wire:model="s_city">
                        @error('s_city') <span class="text-danger">{{ $message }}</span> @enderror
                    </div>
                    <div class="input">
                        <span>province</span>
                        <input class="@error('s_province') is-invalid @enderror" type="text"
                            placeholder="enter your province" name="s_province" wire:model="s_province">
                ...
                <div class="inputBox">
                    <div class="input">
                        <span>country</span>
                        <input class="@error('s_country') is-invalid @enderror" type="text"
                            placeholder="enter your country" name="s_country" wire:model="s_country">
                        @error('s_country') <span class="text-danger">{{ $message }}</span> @enderror
                    </div>
                    <div class="input">
                        <span>zipcode</span>
                        <input class="@error('s_zipcode') is-invalid @enderror" type="text"
                            placeholder="enter your zipcode" name="s_zipcode" wire:model="s_zipcode">
                ...
                <div class="input">
                    ...
                    <div class="inputBox bg-gray-100 px-3 py-6 border rounded">
                        ...
                        <div class="input">
                            ...
                            <input class="@error('card_no') is-invalid @enderror" type="text"
                                placeholder="enter your card number" name="card-no" wire:model="card_no">
                            @error('card_no') <span class="text-danger">{{ $message }}</span> @enderror
                        </div>
                        <div class="input">
                            <span>CVC:</span>
                            <input class="@error('cvc') is-invalid @enderror" type="password"
                                placeholder="enter your CVC" name="cvc" wire:model="cvc">
                            @error('cvc') <span class="text-danger">{{ $message }}</span> @enderror
                        </div>
                        <div class="input">
                            <span>Expiry Month:</span>
                            <input class="@error('exp_month') is-invalid @enderror" type="text"
                                placeholder="enter your expiry month" name="exp_month" wire:model="exp_month">
                            @error('exp_month') <span class="text-danger">{{ $message }}</span> @enderror
                        </div>
                        <div class="input">
                            <span>Expiry Year:</span>
                            <input class="@error('exp_year') is-invalid @enderror" type="text"
                                placeholder="enter your expiry year" name="exp-year" wire:model="exp_year">
                    ...
                    <div class="inputBox">
                        <div class="input">
                            <label for="cod"><span>Cash on Delivery
                                    ...
                                    @if ($paymentmode == 'cod')<b style="color: green;">( Order Pay on Delivery
                                        )</b>@endif
                                </span></label>
                        </div>
            ...
            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                <h1 class="sub-heading" style="color:red;"><i class="icon fas fa-check"></i> {{
                    Session::get('checkout_message') }}</h1>
            </div>
            @endif
        </form>
    </section>
