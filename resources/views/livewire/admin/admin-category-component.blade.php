			...
			<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
				<div class="d-md-flex">
					<ol class="breadcrumb ms-auto">
						...
						<li class="breadcrumb-item active"><a href="{{ route('admin.category') }}" class="fw-normal ">Category</a>
						</li>
					</ol>
				...
				<div class="white-box">
					...
					@if (Session::has('del_message'))
						<div class="alert alert-danger alert-dismissible fade show" role="alert">
							<h5><i class="icon fas fa-check"></i> Category Deleted!</h5>{{ Session::get('del_message') }}
							<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
						</div>
					@endif
					@if (Session::has('up_message'))
						<div class="alert alert-info alert-dismissible fade show" role="alert">
							<h5><i class="icon fas fa-check"></i> Category Updated!</h5>{{ Session::get('up_message') }}
							<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
						</div>
					@endif
					<div class="row">
						...
						<div class="col"><a href="{{ route('admin.addcategory') }}" class="btn btn-success float-end"><i
							...
							<tbody>
								@foreach ($categories as $category)
									<tr>
										...
										<td>
											<a href="{{ route('admin.editcategory', ['category_id' => $category->id]) }}"
											...
											<a href="#" class="btn btn-danger btn-sm text-light"
												...
												wire:click.prevent="deleteCategory({{ $category->id }})"><i class="fas fa-trash mr-2"></i> Delete</a>
										</td>
									</tr>
								@endforeach
							</tbody>
