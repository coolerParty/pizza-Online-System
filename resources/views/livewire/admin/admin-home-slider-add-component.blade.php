                ...
                <div class="d-md-flex">
                    <ol class="breadcrumb ms-auto">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.homeslider') }}" class="fw-normal ">Home
                                Slider</a></li>
                        <li class="breadcrumb-item active"><a href="{{ route('admin.addhomeslider') }}"
            ...
            <div class="col-md-8 col-sm-8">
                <div class="white-box">
                    ...
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                        <h5><i class="icon fas fa-check"></i> Slide Added!</h5>{{ Session::get('message') }}
                    ...
                    <!-- form start -->
                    <form wire:submit.prevent="addSlider" class="form-horzontal form-material">
                        <div class="card-body">
