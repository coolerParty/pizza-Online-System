			...
			<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
				<div class="d-md-flex">
					<ol class="breadcrumb ms-auto">
						...
						<li class="breadcrumb-item active"><a href="{{ route('admin.addinfo') }}" class="fw-normal ">Add</a></li>
					</ol>
				</div>
			</div>
		</div>
