			...
			<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
				<div class="d-md-flex">
					<ol class="breadcrumb ms-auto">
						...
						<li class="breadcrumb-item"><a href="{{ route('admin.permission') }}" class="fw-normal ">Permission</a></li>
						<li class="breadcrumb-item active"><a href="{{ route('admin.addpermission') }}" class="fw-normal ">Add</a></li>
					</ol>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-8 col-sm-8">
				<div class="white-box">
					...
					<!-- form start -->
					<form wire:submit.prevent="addPermission" class="form-horzontal form-material">
						<div class="card-body">
