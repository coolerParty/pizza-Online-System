            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <div class="d-md-flex">
                    <ol class="breadcrumb ms-auto">
                        ...
                        <li class="breadcrumb-item active"><a href="{{ route('admin.addrole') }}"
                                class="fw-normal ">Add</a></li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <form wire:submit.prevent="addRole" class="form-horzontal form-material">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                @error('selected_permissions')<div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <div class="grid gap-1 md:grid-cols-4">
                                    ...
                                    <div
                                        class="px-3 py-2 rounded border border-gray-400 bg-slate-100 hover:bg-slate-400">
                                        <label>
                                            <input type="checkbox" value="{{ $value->name }}" name="permissionList[]"
