        ...
        <form wire:submit.prevent="sendMessage">
            ...
            <div class="inputBox">
                <div class="input">
                    ...
                    <input type="text" placeholder="enter your name" class="@error('name') err_input @enderror"
                        wire:model="name">
                ...
                <div class="input">
                    <span>Website</span>
                    <span
                        style="border-bottom: 1px solid rgb(5, 155, 0); padding: 10px;"><b>www.pizzaorderingOnline.com</b></span>
                </div>
            </div>
            <div class="inputBox">
                <div class="input">
                    ...
                    <input type="number" placeholder="enter your number" class="@error('phone') err_input @enderror"
                        wire:model="phone">
                </div>
                <div class="input">
                    <span>Phone</span>
            ...
            <div class="inputBox">
                <div class="input">
                    ...
                    <input type="email" placeholder="enter your email" class="@error('email') err_input @enderror"
                        wire:model="email">
                </div>
                <div class="input">
                    <span>Email</span>
            ...
            <div class="inputBox">
                <div class="input">
                    ...
                    <textarea name="" placeholder="enter your comment" class="@error('comment') err_input @enderror"
                        id="" cols="30" rows="10" wire:model="comment"></textarea>
                </div>
                <div class="input">
                    <span>Map</span>
                    <iframe
